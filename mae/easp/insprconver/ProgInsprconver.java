...
// Fecha y hora:     Thu Aug 04 19:27:36 CEST 2022
// 
// Aplicación: easp
// 
...
// a partir d'ara utilitzem el sentencies de la classe externa que hi ha a insprconver
  ...
  if (versio < 10.5) {
   ...
   if (versio < 16.1) {
    ...
    if (versio < 17.6) {
        for (i = 0; i < Sentencias.sentencias17_6.length; ++i) {
            try {
                Easp.chivato("17.6 Exec : ["+Sentencias.sentencias17_6[i]+"]",1);
                Easp.connEA.executeUpdate(Sentencias.sentencias17_6[i]);
            }
            catch(Exception e) {
                sqlOperation=Sentencias.sentencias17_6[i];
                Easp.chivato("17.6 *** Error : ["+Sentencias.sentencias17_6[i]+"]  Error: ["+e+"]",1);
                errorMessage=e.getMessage();
            }
        }
        Easp.setVersionBD("bdeasp","17.6");
        Easp.connEA.commit();
    ...
    if (versio < 18.1) {
        for (i = 0; i < Sentencias.sentencias18_1.length; ++i) {
            try {
                ...
                Easp.connEA.executeUpdate(Sentencias.sentencias18_1[i]);
            }
            catch(Exception e) {
                sqlOperation=Sentencias.sentencias18_1[i];
                Easp.chivato("18.1 *** Error : ["+Sentencias.sentencias18_1[i]+"]  Error: ["+e+"]",1);
                errorMessage=e.getMessage();
            }
        }
    ...
    if (versio < 18.4) {
    	for (i = 0; i < Sentencias.sentencias18_4.length; ++i) {
    		try {
    			Easp.chivato("18.4 Exec : ["+Sentencias.sentencias18_4[i]+"]",1);
    			Easp.connEA.executeUpdate(Sentencias.sentencias18_4[i]);
    		}
    		catch(Exception e) {
    			sqlOperation=Sentencias.sentencias18_4[i];
    			Easp.chivato("18.4 *** Error : ["+Sentencias.sentencias18_4[i]+"]  Error: ["+e+"]",1);
    			errorMessage=e.getMessage();
    		}
    	}
    ...
    if (versio < 18.6) {
    	 for (i = 0; i < Sentencias.sentencias18_6.length; ++i) {
    		try {
    			Easp.chivato("18.6 Exec : ["+Sentencias.sentencias18_6[i]+"]",1);
    			Easp.connEA.executeUpdate(Sentencias.sentencias18_6[i]);
    		}
    		catch(Exception e) {
    			sqlOperation=Sentencias.sentencias18_6[i];
    			Easp.chivato("18.6 *** Error : ["+Sentencias.sentencias18_6[i]+"]  Error: ["+e+"]",1);
    			errorMessage=e.getMessage();
    		}
    	}
     String tablas[] = {"AMORTIZACION"};
     Easp.leerSecuencial(Easp.connEA,tablas,"mae/easp/ver1806","easp.jar");
    	Easp.setVersionBD("bdeasp","18.6");     	
    	Easp.connEA.commit();
    	vvveractual.setValue("18.6");
    }
    if (versio < 18.7) {
    	 for (i = 0; i < Sentencias.sentencias18_7.length; ++i) {
    		try {
    			Easp.chivato("18.7 Exec : ["+Sentencias.sentencias18_7[i]+"]",1);
    			Easp.connEA.executeUpdate(Sentencias.sentencias18_7[i]);
    		}
    		catch(Exception e) {
    			sqlOperation=Sentencias.sentencias18_7[i];
    			Easp.chivato("18.7 *** Error : ["+Sentencias.sentencias18_7[i]+"]  Error: ["+e+"]",1);
    			errorMessage=e.getMessage();
    		}
    	}
    	Easp.setVersionBD("bdeasp","18.7");
    	Easp.connEA.commit();
    	vvveractual.setValue("18.7");
    }
    if (versio < 18.8) {
         for (i = 0; i < Sentencias.sentencias18_8.length; ++i) {
                try {
                        Easp.chivato("18.8 Exec : ["+Sentencias.sentencias18_8[i]+"]",1);
                        Easp.connEA.executeUpdate(Sentencias.sentencias18_8[i]);
                }
                catch(Exception e) {
                        sqlOperation=Sentencias.sentencias18_8[i];
                        Easp.chivato("18.8 *** Error : ["+Sentencias.sentencias18_8[i]+"]  Error: ["+e+"]",1);
                        errorMessage=e.getMessage();
                }
        }
        Easp.setVersionBD("bdeasp","18.8");
        Easp.connEA.commit();
        vvveractual.setValue("18.8");
    }
    if (versio < 18.9) {
         for (i = 0; i < Sentencias.sentencias18_9.length; ++i) {
                try {
                        Easp.chivato("18.9 Exec : ["+Sentencias.sentencias18_9[i]+"]",1);
                        Easp.connEA.executeUpdate(Sentencias.sentencias18_9[i]);
                }
                catch(Exception e) {
                        sqlOperation=Sentencias.sentencias18_9[i];
                        Easp.chivato("18.9 *** Error : ["+Sentencias.sentencias18_9[i]+"]  Error: ["+e+"]",1);
                        errorMessage=e.getMessage();
                }
        }
    ...
    if (versio < 19.2) {
         for (i = 0; i < Sentencias.sentencias19_2.length; ++i) {
                try {
                        Easp.chivato("19.2 Exec : ["+Sentencias.sentencias19_2[i]+"]",1);
                        Easp.connEA.executeUpdate(Sentencias.sentencias19_2[i]);
                }
                catch(Exception e) {
                        sqlOperation=Sentencias.sentencias19_2[i];
                        Easp.chivato("19.2 *** Error : ["+Sentencias.sentencias19_2[i]+"]  Error: ["+e+"]",1);
                        errorMessage=e.getMessage();
                }
        }
        Easp.setVersionBD("bdeasp","19.2");
        Easp.connEA.commit();
        vvveractual.setValue("19.2");
    }
    if (versio < 19.3) {
         for (i = 0; i < Sentencias.sentencias19_3.length; ++i) {
                try {
                        Easp.chivato("19.3 Exec : ["+Sentencias.sentencias19_3[i]+"]",1);
                        Easp.connEA.executeUpdate(Sentencias.sentencias19_3[i]);
                }
                catch(Exception e) {
                        sqlOperation=Sentencias.sentencias19_3[i];
                        Easp.chivato("19.3 *** Error : ["+Sentencias.sentencias19_3[i]+"]  Error: ["+e+"]",1);
                        errorMessage=e.getMessage();
                }
        }
        Easp.setVersionBD("bdeasp","19.3");
        Easp.connEA.commit();
        vvveractual.setValue("19.3");
    }
    if (versio < 19.4) {
        for (i = 0; i < Sentencias.sentencias19_4.length; ++i) {
               try {
                       Easp.chivato("19.4 Exec : ["+Sentencias.sentencias19_4[i]+"]",1);
                       Easp.connEA.executeUpdate(Sentencias.sentencias19_4[i]);
               }
               catch(Exception e) {
                       sqlOperation=Sentencias.sentencias19_4[i];
                       Easp.chivato("19.4 *** Error : ["+Sentencias.sentencias19_4[i]+"]  Error: ["+e+"]",1);
                       errorMessage=e.getMessage();
               }
       }
       Easp.setVersionBD("bdeasp","19.4");
       Easp.connEA.commit();
       vvveractual.setValue("19.4");
   }
   if (versio < 19.5) {
        for (i = 0; i < Sentencias.sentencias19_5.length; ++i) {
               try {
                       Easp.chivato("19.5 Exec : ["+Sentencias.sentencias19_5[i]+"]",1);
                       Easp.connEA.executeUpdate(Sentencias.sentencias19_5[i]);
               }
               catch(Exception e) {
                       sqlOperation=Sentencias.sentencias19_5[i];
                       Easp.chivato("19.5 *** Error : ["+Sentencias.sentencias19_5[i]+"]  Error: ["+e+"]",1);
                       errorMessage=e.getMessage();
               }
       }
       Easp.setVersionBD("bdeasp","19.5");
       Easp.connEA.commit();
       vvveractual.setValue("19.5");
   }
  }
  catch(Exception e) {
