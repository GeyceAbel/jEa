...
public class ProgInsindices extends Program
  ...
  "CREATE NONCLUSTERED INDEX ID_LIQUIDARES1     ON LIQUIDARES     (lrsejeraplic, lrsdeclaran, lrsmuf, lrstipocalculo);", 
  "CREATE NONCLUSTERED INDEX ID_LIQUIDAANEXOA1  ON LIQUIDAANEXOA1 (la1ejeraplic, la1declaran, la1muf, la1tipocalculo);", 
  "CREATE NONCLUSTERED INDEX ID_LIQUIDAANEXOA2  ON LIQUIDAANEXOA2 (la2ejeraplic, la2declaran, la2muf, la2tipocalculo);", 
  "CREATE NONCLUSTERED INDEX ID_LIQUIDAANEXOA3  ON LIQUIDAANEXOA3 (la3ejeraplic, la3declaran, la3muf, la3tipocalculo);", 
  "CREATE NONCLUSTERED INDEX ID_LIQUIDAAPARTB1  ON LIQUIDAAPARTB1 (lb1ejeraplic, lb1declaran, lb1muf, lb1tipocalculo);" 
  };
  ...
  "ALTER INDEX ID_LIQUIDAANEXOA1  ON LIQUIDAANEXOA1  REBUILD WITH ( PAD_INDEX=OFF, STATISTICS_NORECOMPUTE=OFF, ALLOW_ROW_LOCKS=ON, ALLOW_PAGE_LOCKS=ON, SORT_IN_TEMPDB=OFF, ONLINE=OFF )",
  ...
  "ALTER INDEX ID_LIQUIDAANEXOA3  ON LIQUIDAANEXOA3  REBUILD WITH ( PAD_INDEX=OFF, STATISTICS_NORECOMPUTE=OFF, ALLOW_ROW_LOCKS=ON, ALLOW_PAGE_LOCKS=ON, SORT_IN_TEMPDB=OFF, ONLINE=OFF )",
  "ALTER INDEX ID_LIQUIDAAPARTB1  ON LIQUIDAAPARTB1  REBUILD WITH ( PAD_INDEX=OFF, STATISTICS_NORECOMPUTE=OFF, ALLOW_ROW_LOCKS=ON, ALLOW_PAGE_LOCKS=ON, SORT_IN_TEMPDB=OFF, ONLINE=OFF )"
  };
