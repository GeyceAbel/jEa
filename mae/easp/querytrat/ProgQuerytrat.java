    ...
    return false;
        ...
        public class CtrlVvselec extends ColumnCheck
            ...
            public CtrlVvselec(Form form)
                ...
                setTitle("Variable de selección");
                // SET: CHECKBOX
                }
            // EVENT: CHECKBOX
        ...
        public class CtrlVvlogica extends ColumnCheck
            ...
            public CtrlVvlogica(Form form)
                ...
                super(form);
                setName("vvlogica");
                setMessageHelp("lógica de selección ( AND OR y parentesis)");
                setTitle("Lógica de selección");
                // SET: CHECKBOX
                }
            // EVENT: CHECKBOX
            public boolean valid ()
        ...
        public class CtrlVvisible extends ColumnCheck
            ...
            public CtrlVvisible(Form form)
                ...
                super(form);
                setName("vvisible");
                setTitle("Visible (Sólo marcar en variables donde el valor se seleccione manualmente)");
                // SET: CHECKBOX
                }
            // EVENT: CHECKBOX
            public boolean valid ()
