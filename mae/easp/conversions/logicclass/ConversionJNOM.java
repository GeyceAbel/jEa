...
public class ConversionJNOM extends ConversionLC {
	...
	private String conceptoConvenio="E";
	
	
	public ConversionJNOM (Program pr,int idConversion, int desdeEmp, int hastaEmp, int desdeEjer, int hastaEjer, String servidor, String instancia, String nombreBD, String user, String passwd,String tipoDpto, String conceptoConvenio, DBConnection connEA) {
	...
	protected void initPrograma() {
      ...
      //pr.setConnection(dbJnom);
		...
		*/
		...
		prNom.vconvers.vvconempconv	.setValue(conceptoConvenio);
