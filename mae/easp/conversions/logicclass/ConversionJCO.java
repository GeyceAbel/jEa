...
public class ConversionJCO extends ConversionLC {
	...
	private boolean importarAsientos (int iEmp, int iEjerL, int empJconta, int iEjerJ, Date fechaCierre, int mesInicio) {
		...
		smov.execute("Select * from Movimientos where CodigoEmpresa="+iEmp+" and Ejercicio="+iEjerL+" and NumeroPeriodo>0 and (NumeroPeriodo<98 or (NumeroPeriodo=98 and Comentario='Cierre Patrimonio'))order by Asiento");
