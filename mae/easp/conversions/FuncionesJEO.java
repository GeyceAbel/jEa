...
import mae.easp.db.CatJeo;
import mae.easp.general.Easp;
import mae.general.Numero;



public class FuncionesJEO {
	DBConnection connEA;
	String dominio;
  public DBConnection connJEO=null;

  public FuncionesJEO(DBConnection connEA, String dominio) {
		this.connEA = connEA;
