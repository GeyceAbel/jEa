...
public class PrintJasperPanelPDFQuer extends PrintJasperPanel
{
  ...
  public PrintJasperPanelPDFQuer(PrintJasperWork job)
  {
    super();
    super.job = job;
  }
  ...
  {
	 setLayout(new LayoutHtml("mae/general/jreports/PrintPanelPDFQuer.html"));
	 creaControls();
	 ...
	 if(setRegistrePre.next()) { 
	   ...
	   margenDer.setValue(parametros.get(2));
  	  ...
  	  if(parametros.get(8) != null) {
   	     destino.setValue(parametros.get(8));
  	  }
  ...
  protected void creaControls()
  {
    ...
    crear = new ControlButton(this)
	{
		public void onClick()
		{
			if (PrintJasperPanelPDFQuer.this.isValid()) {
			...
			if(result ==Maefc.YES_OPTION)	onImprimir(false);
			}
		}
	};
