	...
	private boolean CambiarNIFJModelos(DBConnection connJModelos)
	{
		...
		while(execute && oldNIFSelector.next())
		{
			...
			else
			{
				...
				i.valor("m300devivbase1", oldNIFSelector.getint("m300devivbase1"));
				i.valor("m300devivpor1", oldNIFSelector.getint("m300devivpor1"));
				i.valor("m300devivcuota1", oldNIFSelector.getint("m300devivcuota1"));
				i.valor("m300devivbase2", oldNIFSelector.getint("m300devivbase2"));
				i.valor("m300devivpor2", oldNIFSelector.getint("m300devivpor2"));
				i.valor("m300devivcuota2", oldNIFSelector.getint("m300devivcuota2"));
				i.valor("m300devivbase3", oldNIFSelector.getint("m300devivbase3"));
				i.valor("m300devivpor3", oldNIFSelector.getint("m300devivpor3"));
				i.valor("m300devivcuota3", oldNIFSelector.getint("m300devivcuota3"));
				i.valor("m300devrebase1", oldNIFSelector.getint("m300devrebase1"));
				i.valor("m300devrepor1", oldNIFSelector.getint("m300devrepor1"));
				i.valor("m300devrecuota1", oldNIFSelector.getint("m300devrecuota1"));
				i.valor("m300devrebase2", oldNIFSelector.getint("m300devrebase2"));
				i.valor("m300devrepor2", oldNIFSelector.getint("m300devrepor2"));
				i.valor("m300devrecuota2", oldNIFSelector.getint("m300devrecuota2"));
				i.valor("m300devrebase3", oldNIFSelector.getint("m300devrebase3"));
				i.valor("m300devrepor3", oldNIFSelector.getint("m300devrepor3"));
				i.valor("m300devrecuota3", oldNIFSelector.getint("m300devrecuota3"));
				i.valor("m300devadqbase", oldNIFSelector.getint("m300devadqbase"));
				i.valor("m300devadqquota", oldNIFSelector.getint("m300devadqquota"));
				i.valor("m300totcuotdev", oldNIFSelector.getint("m300totcuotdev"));
				i.valor("m300dedopin", oldNIFSelector.getint("m300dedopin"));
				i.valor("m300dedimpor", oldNIFSelector.getint("m300dedimpor"));
				i.valor("m300dedadq", oldNIFSelector.getint("m300dedadq"));
				i.valor("m300dedopinb", oldNIFSelector.getint("m300dedopinb"));
				i.valor("m300dedimporb", oldNIFSelector.getint("m300dedimporb"));
				i.valor("m300dedadqb", oldNIFSelector.getint("m300dedadqb"));
				i.valor("m300dedragp", oldNIFSelector.getint("m300dedragp"));
				i.valor("m300dedrinv", oldNIFSelector.getint("m300dedrinv"));
				i.valor("m300totded", oldNIFSelector.getint("m300totded"));
				i.valor("m300atradmonpor", oldNIFSelector.getint("m300atradmonpor"));
				i.valor("m300atradmon", oldNIFSelector.getint("m300atradmon"));
				i.valor("m300cuotcompen", oldNIFSelector.getint("m300cuotcompen"));
				i.valor("m300entregas", oldNIFSelector.getint("m300entregas"));
				i.valor("m300estydiput", oldNIFSelector.getint("m300estydiput"));
				i.valor("m300resultado", oldNIFSelector.getint("m300resultado"));
				i.valor("m300impcompen", oldNIFSelector.getint("m300impcompen"));
				i.valor("m300sinactiv", oldNIFSelector.getString("m300sinactiv"));
				i.valor("m300impdevol", oldNIFSelector.getint("m300impdevol"));
				...
				i.valor("m300exporta", oldNIFSelector.getint("m300exporta"));
				i.valor("m300otrasopex", oldNIFSelector.getint("m300otrasopex"));
				i.valor("m300opsujdev", oldNIFSelector.getint("m300opsujdev"));
				i.valor("m300opnosujdev", oldNIFSelector.getint("m300opnosujdev"));
				i.valor("m300maxdevol", oldNIFSelector.getint("m300maxdevol"));
				i.valor("m300adevolver", oldNIFSelector.getint("m300adevolver"));
				i.valor("m300acompensar", oldNIFSelector.getint("m300acompensar"));
				...
				i.valor("m300regpro", oldNIFSelector.getint("m300regpro"));
				i.valor("m300adeducir", oldNIFSelector.getint("m300adeducir"));
				i.valor("m300resultliq", oldNIFSelector.getint("m300resultliq"));
		...
		while(execute && oldNIFSelector.next())
		{
			...
			if(newNIFSelector.next())
			{
				...
				grabarIncidencia("jModelos", "Se ha eliminado el modelo 190-"+oldNIFSelector.getint("m190dejercicio")+"-"+oldNIF+" ya que existía un 190 con el nuevo NIF "+newNIF);
			}
			else
			{
				/*No existe el registro con el nuevo NIF --> lo creamos*/
