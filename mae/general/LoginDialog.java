...
public class LoginDialog{
  ...
  private JLabel labeltt=new JLabel("<html><font size=1 face=arial color=red>Si no ha configurado su acceso, <p>puede entrar en la aplicación como usuario <i>ADMIN</i>"+
